# Digitale Transformation der Arbeitswelt: Auswirkungen von Remotearbeit auf Ökonomie, Ökologie und Soziales
...
Welche der Systeme, Geräte und Medien werden Ihnen von Ihrem Arbeitgeber (unentgeltlich) zur Verfügung gestellt? [Statista: https://de.statista.com/statistik/daten/studie/1297302/umfrage/homeoffice-bereitstellung-von-geraeten-durch-arbeitgeber/]
- 69% Hardware
- 32% Fernzugang
- 31% Videokonferenzdienst
- 20% Kollaborationstools
- 19% Nichts davon

### Datenschutz und Sicherheitsaspekte

Mobiles Arbeiten Datenschutz [BfDI: https://www.bfdi.bund.de/SharedDocs/Downloads/DE/Flyer/Telearbeit.pdf?__blob=publicationFile]

- schützenswerte Daten
    - Personenbezogene Daten
    - Beschäftigtendaten (Daten die der Arbeitgeber im Laufe eines Berufslebens sammelt)
    - Sozialdaten
    - Welche Vorkehrungen müssen für den Umgang mit diesen Daten im Homeoffice getroffen werden?
        - Datenmissbrauch reduzieren
        - Grundsatz: Je sensibler und damit schützenswerter die Daten sind, desto höher sind die Anforderungen an die Sicherheit der Datenverarbeitung
- Risiken
    - Missbrauch oder unbefugter Datenzugriff
        - Kommunikation über verschlüsselte elektronische Kommunikationswege
    - Medienbruchfreie Gestaltung. (Alles digital am Firmenrechner, kein Papier)
    - Verlust des Firmenrechners
        - Daten verschlüsseln
...
[BfDI: https://www.bfdi.bund.de/SharedDocs/Downloads/DE/Flyer/Telearbeit.pdf?__blob=publicationFile]

- Verbindung zum Firmennetzwerk ausschließlich über VPN
- 2FA (Hardwaretoken)
- Eingeschränkte IT-Infrastruktur im Homeoffice
- Keine USB-Zugänge
- Eingeschränkte zugriffsmöglichkeiten auf das Firmennetzwerk
- 15,7% finden Technische Probleme im Homeoffice besonders belastend [Statista: https://de.statista.com/statistik/daten/studie/1279392/umfrage/belastende-faktoren-im-homeoffice/]
...
**Studie 2014**:
Homeoffice verbessert die Vereinbarkeit von Arbeit und Privatleben [WSI: https://www.boeckler.de/pdf/p_wsi_report_54_2020.pdf]
